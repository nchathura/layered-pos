...
public class OrderDetailDAO {
    public static ArrayList<Order> findAllOrderDetail(){
        try {
    ...
    public static boolean saveCustomer(OrderDetail orderDetail){
        try {
            Connection connection = DBConnection.getInstance().getConnection();
    ...
    public static boolean deleteCustomer(OrderDetailPK orderDetailPK){
        try {
            Connection connection = DBConnection.getInstance().getConnection();
    ...
    public static boolean updateCustomer(OrderDetail orderDetail){
        try {
            Connection connection = DBConnection.getInstance().getConnection();
